...
- **Chat Message Encryption**: Now chat messages are encrypted in the database [details](https://xiansaiplatform.github.io/XiansAi.PublicDocs/n-encyclopedia/chat-message-encryption/)
...
- **Server Configuration**: `EncryptionKeys__**` environment variables are now required with a string value. These keys are used to encrypt and decrypt database values.
